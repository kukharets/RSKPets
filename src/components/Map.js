    ...
    const pathCoordinates = [
        ...
        return (
            ...
            <div style={{ height: '100vh', width: '100%' }}>
                ...
                { this.state.mapLoaded && <Polyline map={this.state.map} maps={this.state.maps} origin={{lat: 36.05298765935, lng: -112.083756616339}} destination={{lat: 36.2169884797185, lng: -112.056727493181}} /> }
            </div>
        );
    }
}
